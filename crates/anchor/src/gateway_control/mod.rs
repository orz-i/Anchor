...
pub use ipc::{
    ...
    request_events, request_exit, request_logs, request_reload, request_set_routes, request_status,
    request_version, status_via_daemon_or_local, GatewayControlClientError, GatewayControlCommand,
    GatewayControlReceiver, GatewayControlSender, GatewayControlServer, GatewayLocalEndpoint,
    GatewayVersionInfo,
};
#[cfg(any(feature = "cli", test))]
pub(crate) use ipc::{finish_operation, mark_operation_running};
