...
mod tests {
    ...
    fn initialize_instructions_define_the_history_persistence_workflow() {
        ...
        assert!(instructions.contains("legacy list_skills/load_skill/list_skill_resources/read_skill_resource routes remain callable"));
        assert!(instructions.contains("intentionally not published in tools/list"));
