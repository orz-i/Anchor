...
use commands::{
    ...
    get_runtime_status, get_shared_secret, get_workspace_control_status, get_workspace_secret,
    inspect_workspace_skills, install_software, list_canvs_tasks, list_frp_profiles, list_software,
    list_workspaces, open_workspace_directory, read_workspace_logs, regenerate_shared_secret,
